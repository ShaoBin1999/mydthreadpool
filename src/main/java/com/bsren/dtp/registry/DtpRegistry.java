...
import com.bsren.dtp.properties.ThreadPoolProperties;
...
import static com.bsren.dtp.dto.NotifyItem.mergeAllNotifyItems;
import static com.bsren.dtp.em.ExecutorType.EAGER;
import static com.bsren.dtp.em.QueueTypeEnum.MEMORY_SAFE_LINKED_BLOCKING_QUEUE;
import static com.bsren.dtp.em.QueueTypeEnum.VARIABLE_LINKED_BLOCKING_QUEUE;
...
public class DtpRegistry implements ApplicationRunner, Ordered {
    ...
    private static void refresh(DtpExecutor executor, ThreadPoolProperties properties) {
        ...
        val notifyItem = NotifyItemManager.getNotifyItem(executor, NotifyItemEnum.CONFIG_CHANGE);
        val executorWrapper = new ExecutorWrapper(executor.getThreadPoolName(), executor, properties.isNotifyEnabled());
        NoticeNotifyCtx context = new NoticeNotifyCtx(executorWrapper, notifyItem, dtpProperties.getPlatforms(), oldProp, diffKeys);
