...
import com.bsren.dtp.em.ExecutorType;
...
import com.bsren.dtp.util.BeanUtil;
...
import static com.bsren.dtp.em.QueueTypeEnum.buildBlockingQueue;
...
public class DtpBeanDefinitionRegistrar
    ...
    private Object[] buildConstructorArgs(Class<?> clazz, ThreadPoolProperties tpp) {
        ...
        if (clazz.equals(EagerDtpExecutor.class)) {
            ...
            taskQueue = buildBlockingQueue(tpp.getQueueType(), tpp.getQueueCapacity(), tpp.isFair(), tpp.getMaxFreeMemory());
        }
